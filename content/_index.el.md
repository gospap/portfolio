...
<figure class="photo">
<img class="no-hover" src="/media/bench.webp" alt="Βαθμίδα με τρανζίστορ σε breadboard, συνδεδεμένη με τροφοδοτικό πάγκου και γεννήτρια συχνοτήτων, με την έξοδο στον παλμογράφο" loading="lazy" width="720" height="960" />
<figcaption>Στον πάγκο: βαθμίδα με τρανζίστορ στο breadboard, οδηγημένη από τη γεννήτρια συχνοτήτων και μετρημένη στον παλμογράφο.</figcaption>
</figure>
